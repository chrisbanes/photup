...
public class Filter {
	...
	public static Filter[] getFilters() {
		return new Filter[] { 
				new Filter(FILTER_ORIGINAL, R.string.filter_original),
				new Filter(FILTER_INSTAFIX, R.string.filter_instafix),
				new Filter(FILTER_ANSEL, R.string.filter_ansel),
				new Filter(FILTER_TESTINO, R.string.filter_testino),
				new Filter(FILTER_XPRO, R.string.filter_xpro),
				new Filter(FILTER_RETRO, R.string.filter_retro),
				new Filter(FILTER_BW, R.string.filter_bw),
				new Filter(FILTER_SEPIA, R.string.filter_sepia),
				new Filter(FILTER_CYANO, R.string.filter_cyano),
				new Filter(FILTER_GEORGIA, R.string.filter_georgia),
				new Filter(FILTER_SAHARA, R.string.filter_sahara),
